...
<section class="lg-form-outer">
    <div class="lg-form-header">Inventory - Add New UOM</div>
    <form autocomplete="off" class="lg-form" method="POST" id="MyForm" onsubmit="return save()">
        ...
        <section class="section-111" style="max-width: 1200px">
            <div>
                <fieldset>
                    <legend>Add New Unit Of Measurement</legend>
                    <div class="field-section single-column">
                        <div class="field-p">
                            <label>Unit</label>
                            <input name="uom" type="text" required>
                        </div>
                    </div>
                    <div class="field-section single-column">
                        <div class="field-p">
                            <label>Unit Type</label>
                            <input name="uom_type" type="text" required>
                        </div>
                    </div>
                </fieldset>
                <br>
