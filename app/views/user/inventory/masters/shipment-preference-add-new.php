...
<section class="lg-form-outer">
    <div class="lg-form-header">Inventory - Add New Shipment Preference</div>
    <form autocomplete="off" class="lg-form" method="POST" id="MyForm" onsubmit="return save()">
        ...
        <section class="section-111" style="max-width: 1200px">
            <div>
                <fieldset>
                    <legend>Add New Shipment Preference</legend>
                    <div class="field-section single-column">
                        <div class="field-p">
                            <label>Shipment Preference</label>
                            <input name="shipment_preference" type="text" required>
                        </div>
                    </div>
                </fieldset>
                <br>
...
<script type="text/javascript">
    function save() {
        ...
        if (isValidForm) {
            ...
            var obj = {
                shipment_preference: $('[name="shipment_preference"]').val(),
            }
            // console.log(obj)
