...
<section class="list-200 content-box" style="margin: auto;max-width: 500px">
    <h1 class="list-200-heading">Inventory - Shipment Preference</h1>
        ...
        <div class="list-200-top-action-right">
            <div>
                ...
                if (in_array('P0406', USER_PRIV)) {
                    echo "<button class='btn_grey button_href'><a href='../user/inventory/masters/shipment-preference/add-new'>Add New</a></button>";
               }
                ?>
            </div>
        </div>
    ...
    <div class="table  table-a">
        <table>
            <thead>
                ...
                <tr>
                    <th>Sr. No.</th>
                    <th data-table-sort-by="name">Shipment Preference</th>
...
<script type="text/javascript">
    function show_list() {
        ...
        get_shipment_preferences(param).then(function(data) {
            ...
            if (data.status) {
                ...
                if (data.response.list) {
                    ...
                    $.each(data.response.list, function(index, item) {
                            ...
                            row += `<td>` + item.shipment_preference_status + `</td>`;
                            row += `<td>`;
                            <?php if (in_array('P0408', USER_PRIV)) {
                            ?>
                                 row += `<button title="Edit" class="btn_grey_c"><a href="../user/inventory/masters/shipment-preference/update?eid=` + item.eid + `"><i class="fa fa-pen"></i></a></button>`;
                            <?php
                            } ?>
