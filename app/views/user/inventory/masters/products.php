...
<section class="list-200 content-box" style="margin: auto;max-width: 500px">
    <h1 class="list-200-heading">Inventory - Products</h1>
    ...
    <section class="list-200-top-action">
        <div class="list-200-top-action-left">
            ...
            <div class="filter-item-full">
                <label>Search</label>
                <input type="text" placeholder="name / type / status" data-filter="search" onkeyup="show_list()">
                </select>
            </div>
        ...
        <div class="list-200-top-action-right">
            <div>
                ...
                if (in_array('P0406', USER_PRIV)) {
                    echo "<button class='btn_grey button_href'><a href='../user/inventory/masters/products/add-new'>Add New</a></button>";
                }
                ?>
            </div>
        </div>
    ...
    <div class="table  table-a">
        <table>
            <thead>
                ...
                <tr>
                    <th>Sr. No.</th>
                    <th data-table-sort-by="name">Product Name</th>
                    <th data-table-sort-by="type">Product Type</th>
                    <th data-table-sort-by="status">Product Status</th>
                    <th>Action</th>
                </tr>
            </thead>
            ...
            if (data.status) {
                ...
                if (data.response.list) {
                    ...
                    $.each(data.response.list, function(index, item) {
                            ...
                            row += `<td>` + item.product_status + `</td>`;
                            row += `<td>`;
                            <?php if (in_array('P0408', USER_PRIV)) {
                            ?>
                                 row += `<button title="Edit" class="btn_grey_c"><a href="../user/inventory/masters/products/update?eid=` + item.eid + `"><i class="fa fa-pen"></i></a></button>`;
                            <?php
                            } ?>
