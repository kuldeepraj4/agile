...
<section class="lg-form-outer">
    <div class="lg-form-header">Inventory - Add New Storage Type</div>
    <form autocomplete="off" class="lg-form" method="POST" id="MyForm" onsubmit="return save()">
        ...
        <section class="section-111" style="max-width: 1200px">
            <div>
                <fieldset>
                    <legend>Add New Storage Type</legend>
                    <div class="field-section single-column">
                        <div class="field-p">
                            <label>Storage Type</label>
                            <input name="storage_type" type="text" required>
                        </div>
                    </div>
                </fieldset>
                <br>
...
<script type="text/javascript">
    function save() {
        ...
        if (isValidForm) {
            ...
            var obj = {
                storage_type: $('[name="storage_type"]').val(),
            }
            // console.log(obj)
