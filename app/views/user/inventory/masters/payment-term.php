...
<section class="list-200 content-box" style="margin: auto;max-width: 500px">
    <h1 class="list-200-heading">Inventory - Payment Terms</h1>
        ...
        <div class="list-200-top-action-right">
            <div>
                ...
                if (in_array('P0406', USER_PRIV)) {
                    echo "<button class='btn_grey button_href'><a href='../user/inventory/masters/payment-term/add-new'>Add New</a></button>";
                }
                ?>
            </div>
        </div>
    ...
    <div class="table  table-a">
        <table>
            <thead>
                ...
                <tr>
                    <th>Sr. No.</th>
                    <th data-table-sort-by="name">Payment Terms</th>
...
<script type="text/javascript">
    function show_list() {
        ...
        get_payment_terms(param).then(function(data) {
            ...
            if (data.status) {
                ...
                if (data.response.list) {
                    ...
                    $.each(data.response.list, function(index, item) {
                            ...
                            row += `<td>` + item.payment_term_status + `</td>`;
                            row += `<td>`;
                            <?php if (in_array('P0408', USER_PRIV)) {
                            ?>
                                 row += `<button title="Edit" class="btn_grey_c"><a href="../user/inventory/masters/payment-term/update?eid=` + item.eid + `"><i class="fa fa-pen"></i></a></button>`;
                            <?php
                            } ?>
