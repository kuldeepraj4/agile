...
$driver_name=isset($_GET['driver-name'])?$_GET['driver-name']:'';
$driver_code=isset($_GET['driver-code'])?$_GET['driver-code']:'';
?>
...
<script type="text/javascript">
  function show_list(){
    $.ajax({
      ...
      type:'POST',
      data:{
        driver_eid:'<?php echo $data['driver_eid'] ?>',
         ...
         if(data.status){
           ...
           $.each(data.response.list, function(index, item) {
            $('#tabledata').append(`
              ...
              <td><button title="Notes" class="btn_grey_c" onclick="open_notes({url:'../user/miscellaneous/notes/details?reference=driver-DOCUMENT&eid=<?php echo $data['driver_eid'] ?>&document-type-eid=${item.type_eid}'})"><i class="fa fa-sticky-note"></i></a></button></td>
              <tr>
              `);
