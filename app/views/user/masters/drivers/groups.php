...
<br><br>
            ...
            <h1 class="list-200-heading">Driver Groups</h1>
    ...
    <section class="list-200-top-action">
        ...
        <div class="list-200-top-action-right">
            <div>
            <?php
            if(in_array('P113', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/drivers/groups/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a">
                <table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Group</th>
...
counter++;
    ...
    row+=`<td>`+counter+`</td>`;
    row+=`<td>`+item.name+`</td>`;
    row+=`<td>`+item.pay_per_mile+`</td>`;
    row+=`<td>`;
<?php if(in_array('P115', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/drivers/groups/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
<?php if(in_array('P116', USER_PRIV)){
    ?>
