...
<br><br>
            ...
            <h1 class="list-200-heading">Designation</h1>
    ...
    <section class="list-200-top-action">
        ...
        <div class="list-200-top-action-right">
            ...
            if(in_array('P0322', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/users/designation-add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a" >
                <table data-table-td-counter data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Designation Name</th>
                        <th>Status</th>
                        <th></th>
                    </tr>                       
                    </thead>
...
function show_list(){
 ...
 get_designation(param).then(function(data) {
...
counter++;
    ...
    row+=`<td>`;
<?php if(in_array('P0324', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/users/designation/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
<?php if(in_array('P0325', USER_PRIV)){
    ?>
