...
<section class="profile-ms-outer" style="padding: 20px 200px; background-color:#fff;">
  <div class="profile-ms-header">TRUCK ID <?php echo $details['code']; ?> <span id="last_update"></span></div>
...
<div>
      <fieldset>
        ...
        <div class="field">
          ...
          <div id="match2"><?php echo $details['group']; ?></div>
        </div>
        <div class="field">
          <label>Company</label>
          <div id="match3"><?php echo $details['company']; ?></div>
        </div>
        <div class="field">
          <label>Make Year</label>
          <div id="match4"><?php echo $details['make_year']; ?></div>
        </div>
        <div class="field">
          <label>Make</label>
          <div id="match5"><?php echo $details['make']; ?></div>
        </div>
        <div class="field">
          <label>Model</label>
          <div id="match6"><?php echo $details['model']; ?></div>
        </div>
        <div class="field">
          <label>Color</label>
          <div id="match7"><?php echo $details['color']; ?></div>
        </div>
        <div class="field">
          <label>VIN</label>
...
<div>
      <fieldset>
        ...
        <div class="field">
          ...
          <div id="match16"><?php echo $details['liability_status']; ?></div>
        </div>
        <div class="field">
          <label>Cargo</label>
          <div id="match17"><?php echo $details['cargo_status']; ?></div>
        </div>        
        <div class="field">
          <label>P/D value</label>
          <div id="match18"><?php echo $details['pd_value']; ?></div>
        </div>        
        <div class="field">
          <label>Loss pay info</label>
          <div id="match19"><?php echo $details['loss_pay_info']; ?></div>
        </div>        
        <div class="field">
          <label>P/D value new</label>
          <div id="match20"><?php echo $details['new_pd_value']; ?></div>
        </div>                        
        </div>                  
      </fieldset>
</div>
<div>
  <fieldset>
        ...
        <div class="field-section">
                  <div class="field">
          <label>FHVUT</label>
         <div id="match21"><?php echo $details['fhvut_status']; ?></div>
        </div>        
        <div class="field">
          <label>Paid date</label>
          <div id="match22"><?php echo $details['fhvut_paid_date']; ?></div>
        </div>
        <div class="field">
          <label>Oregon permit issue</label>
          <div id="match23"><?php echo $details['oregon_permit_status']; ?></div>
        </div>
        <div class="field">
          <label>Family engine no.</label>
          <div id="match24"><?php echo $details['family_engine_number']; ?></div>
        </div>        
        <div class="field">
          <label>IFTA</label>
          <div id="match25"><?php echo $details['ifta_status']; ?></div>
        </div>
        <div class="field">
          <label>PIFTA</label>
          <div id="match26"><?php echo $details['pifta_status']; ?></div>
        </div>
        <div class="field">
          <label>NM permit</label>
            <div id="match27"><?php echo $details['nm_status']; ?></div>
        </div>        
        
        <div class="field">
          <label>Pre pass</label>
          <div id="match28"><?php echo $details['pre_pass']; ?></div>
        </div>        
        <div class="field">
          <label>Pre pass remark</label>
          <div id="match29"><?php echo $details['pre_pass_remark']; ?></div>
        </div>
      <div class="field">
        <label>HUT</label>
        <div id="match30"><?php echo $details['hut']; ?></div>
      </div>
      <div class="field">
        <label>HUT remarks</label>
        <div id="match31"><?php echo $details['hut_remark']; ?></div>
      </div>                                
        </div>                  
      </fieldset>
</div>
  ...
  <fieldset>
    ...
    <div class="field-section">
      <div class="field">
        ...
        <div id="match32" style="text-transform: uppercase;"><?php echo $details['ownership_type']; ?></div>
      </div>        
      <div class="field">
        <label>Lease Ref no</label>
        <div id="match33"><?php echo $details['lease_ref_no']; ?></div>
      </div>                               
      <div class="field">
        <label>Leasing company</label>
        <div id="match34"><?php echo $details['lease_company']; ?></div>
      </div>        
      <div class="field">
        <label>Leasing expiry</label>
        <div id="match35"><?php echo $details['lease_expiry_date']; ?></div>
      </div>                               
    </div>                  
  </fieldset>
</div>
  ...
  <fieldset>
    ...
    <div class="field-section">        
      <div class="field">
        ...
        <div id="match36"><?php echo $details['device_company_name']; ?></div>
      </div>
      <div class="field">
        <label>Gateway serial no.</label>
        <div id="match37"><?php echo $details['device_serial_no']; ?></div>
      </div>       
      <div class="field">
        <label>Dash cam no</label>
        <div id="match38"><?php echo $details['device_dash_cam_no']; ?></div>
      </div>
        <div class="field">
        <label>Halo no.</label>
        <div id="match39"><?php echo $details['halo']; ?></div>
      </div>                                
    </div>                  
  </fieldset>
</div>
  ...
  <fieldset>
    ...
    <div class="field-section">
      <div class="field">
        ...
        <div id="match40"><?php echo $details['odometer_update_type']; ?></div>
      </div>
       <div class="field">
        <label>Engine Hours Update Type</label>
        <div id="match41"><?php echo $details['engine_hours_update_type']; ?></div>
      </div>                                      
    </div>                  
  </fieldset>

  <?php   if($details['truck_approval_status']!=''){?>
  <fieldset>
    <legend>Trucks Status </legend>
    <div class="field-section">        
      <div class="field">
        <label>Approval Status</label>
        <div><?php echo $details['truck_approval_status']; ?></div>
      </div>

      <?php   if($details['truck_approval_status']=='REJECTED'){?>
    ...
    <div class="field">
        ...
        <div><?php echo $details['truck_rejected_on']; ?></div>
    </div>
     <?php } ?>                              
    </div>                  
  </fieldset>
  ...
  $(document).ready(function(){
     $(document).on("click", "[data-action='approve-el']",function(){
        if(confirm('Do you want to approve this ?')){
          ...
          $.ajax({
            url:'user/masters/trucks/approve-details-action',
            type:'POST',
            data:{
              truck_eid:"<?php echo $_GET['eid'] ?>"
          },
          context: this,
  ...
  $(document).ready(function(){
     $(document).on("click", "[data-action='reject-el']",function(){
        if(confirm('Do you want to reject this ?')){
          $.ajax({
            url:'user/masters/trucks/reject-details-action',
            type:'POST',
            data:{
              truck_eid:"<?php echo $_GET['eid'] ?>",
       ...
       complete:function(){
         ...
         if(data.status){
            if (return_to == 0) {
                ...
                location.href = '../user/masters/trucks/update?call-back-page=user/masters/trucks/&eid=<?php echo $_GET['eid'] ?>&page=verify';
            }
        }else{
          alert(data.message)
      }
