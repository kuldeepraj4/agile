...
<br><br>
            ...
            <h1 class="list-200-heading">Cities</h1>
    ...
    <section class="list-200-top-action">
        <div class="list-200-top-action-left">
            ...
            <div class="filter-item">
                <label>Search</label>
            <input type="text" placeholder="Name/ State/ Country" data-filter="search" onkeyup="set_params('page_no', 1);show_list()">
            </select>
            </div>            
            ...
            <div class="table  table-a">
                ...
                <table data-table-td-counter data-ro-table>
                    ...
                    <tr>
                        ...
                        <th data-table-sort-by="zone">Zone</th>
