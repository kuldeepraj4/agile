...
<br><br>
            ...
            <h1 class="list-200-heading">Countries</h1>
    ...
    <section class="list-200-top-action">
        <div class="list-200-top-action-left">
            ...
            <div class="filter-item">
                <label>Search</label>
            <input type="text" placeholder="Country Name" data-filter="search" onkeyup="set_params('page_no', 1);show_list()">
            </select>
            </div>            
        ...
        <div class="list-200-top-action-right">
            ...
            if(in_array('P0013', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/locations/countries/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a" >
                <table data-table-td-counter data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Country Name</th>
                        <th>Action</th>
                    </tr>                       
                    </thead>
...
<?php if(in_array('P0015', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/locations/countries/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
