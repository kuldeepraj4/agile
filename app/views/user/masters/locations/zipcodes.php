...
<br><br>
            ...
            <h1 class="list-200-heading">ZIP Codes</h1>
    ...
    <section class="list-200-top-action">
        <div class="list-200-top-action-left">
            ...
            <div class="filter-item">
                <label>Search</label>
                <input type="text" placeholder="Code/ City/ State/ Country" data-filter="search" onkeyup="set_params('page_no', 1);show_list()">
            </div>
            <div></div>            
        ...
        <div class="list-200-top-action-right">
            ...
            if(in_array('P0013', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/locations/zipcodes/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a">
                ...
                <table data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Code</th>
                        <th data-table-sort-by="city">City</th>
...
<?php if(in_array('P0015', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/locations/zipcodes/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
