...
<br><br>
            ...
            <h1 class="list-200-heading">Vehicle Status</h1>
    ...
    <section class="list-200-top-action">
        ...
        <div class="list-200-top-action-right">
            ...
            if(in_array('P0028', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/vehicles/status/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a">
                <table data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Condition</th>
                        <th></th>
                    </tr>                       
                    </thead>
...
counter++;
    ...
    row+=`<td>`+item.name+`</td>`;
    row+=`<td>`;
<?php if(in_array('P0030', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/vehicles/status/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
<?php if(in_array('P0031', USER_PRIV)){
    ?>
