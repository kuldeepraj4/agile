...
<br><br>
            ...
            <h1 class="list-200-heading">Vehicle Models</h1>
    ...
    <section class="list-200-top-action">
        <div class="list-200-top-action-left">
            ...
            <div class="filter-item">
                <label>Search</label>
            <input type="text" placeholder="Vehicle Model" data-filter="search" onkeyup="set_params('page_no', 1);show_list()">
            </select>
            </div>            
        ...
        <div class="list-200-top-action-right">
            ...
            if(in_array('P0058', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/vehicles/models/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a">
                <table data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Vehicle Model</th>
                        <th>Makes</th>
                        <th>Vehicle</th>
                        <th></th>
                    </tr>                       
...
counter++;
    ...
    row+=`<td>`;
<?php if(in_array('P0060', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/vehicles/models/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
<?php if(in_array('P0061', USER_PRIV)){
    ?>
