...
<section class="profile-ms-outer">
  <div class="profile-ms-header">TRAILER ID <?php echo $details['code']; ?></div>
  <section class="lg-form" style="text-align:right;">
  <?php
  if (in_array('P0025', USER_PRIV)) {
  ?>
    <button class='btn_blue' onclick="location.href='../user/masters/trailers/update?eid=<?php echo $_GET['eid']; ?>&page='">Edit Trailer</button>
  <?php
  }
  ?>
  </section>
