...
<br><br>
            ...
            <h1 class="list-200-heading">Employee Prefix</h1>
    ...
    <section class="list-200-top-action">
        ...
        <div class="list-200-top-action-right">
            ...
            if(in_array('P0088', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/employees/prefix/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a">
                <table data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Prefix</th>
                        <th>Action</th>
                    </tr>                       
                    </thead>
...
<?php if(in_array('P0090', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/employees/prefix/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
...
$(document).ready(function(){
 $(document).on("click", "[data-action='delete']",function(){
    if(confirm('Do you want to delete prefix ?')){
