...
<br><br>
            ...
            <h1 class="list-200-heading">Employee Status</h1>
    ...
    <section class="list-200-top-action">
        ...
        <div class="list-200-top-action-right" style="display: none;">
            <div>
            <?php
            if(in_array('P0083', USER_PRIV)){
                echo "<button class='btn_grey button_href'><a href='../user/masters/employees/status/add-new'>Add New</a></button>";
            }
            ?>
        </div>
        </div>
            ...
            <div class="table  table-a">
                <table  data-ro-table>
                    ...
                    <tr>
                        <th>Sr. No.</th>
                        <th data-table-sort-by="name">Status</th>
...
<?php if(in_array('P0085', USER_PRIV)){
    ?>
    row+=`<button title="Edit" class="btn_grey_c"><a href="../user/masters/employees/status/update?eid=`+item.eid+`"><i class="fa fa-pen"></i></a></button>`;
    <?php
} ?>
<?php if(in_array('P0086', USER_PRIV)){
    ?>
...
$(document).ready(function(){
 $(document).on("click", "[data-action='delete']",function(){
    if(confirm('Do you want to delete employee status ?')){
