...
<!-- 
              <div class="field-p">
                ...
                <input type="text"  name="driver_current_status">
              </div>

              <div class="field-p">
                <label>Current Location</label>
                <input type="text"  name="driver_current_location">
              </div>

              <div class="field-p">
                <label>ETA to planned load</label>
                <input type="text"  name="driver_eta_to_planned_load">
              </div> -->
...
<script type="text/javascript">
  function save(){
    ...
    if(isValidForm){
      ...
      $.ajax({
        url:'../user/dispatch/long-haul-assignments/add-new-action',
        type:'POST',
        data: obj,
