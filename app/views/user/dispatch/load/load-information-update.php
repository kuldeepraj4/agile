          ...
          <div style="display:flex;">
            ...
            <div class="field-p" data-temperature-option>
              <?php if(($load_type_id=='LOT01' || $load_type_id=='LOT03') && $details['trailer_type']=='REEFER'){
                ...
                <div>
                  <input type="text" class="w-150" name="reefer_temperature"
                    <?php if($details['temperature_as_per_shipper']=='YES'){
                        echo "disabled"; 
                    }else{
                      echo " value='".$details['reefer_temperature']."'"; 
                    } ?>
                   > 
                  <select  class="w-150" name="reefer_mode"
                    <?php if($details['temperature_as_per_shipper']=='YES'){
                        echo "disabled  data-default-select='".$details['reefer_mode']."'"; 
                    }else{
                       echo "data-default-select='".$details['reefer_mode']."'"; 
                    } ?>
                   >
                    <option value=""> - - Select - - </option>
...
<script type="text/javascript">
      ...
      $(document.body).on('change', '[name="temperature_as_per_shipper"]' ,function(){
        ...
        if($(this).prop("checked") == true){
          $(this).siblings('[name="reefer_mode"],[name="reefer_temperature"]').prop('disabled',true)
          $(this).siblings('[name="reefer_mode"],[name="reefer_temperature"]').val('')
        }

        else if($(this).prop("checked") == false){

          $(this).siblings('[name="reefer_mode"],[name="reefer_temperature"]').prop('disabled',false)
