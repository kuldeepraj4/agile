        ...
        <div>
          <ul >
            ...
            <li>
              ...
              <select name="appointment_type" data-default-select="<?php echo $dtl['appointment_type']; ?>" required>
                <option value=""> - - Select - -</option>
            ...
            <li>
              <label>Date</label>
              <input type="text" value="<?php echo $dtl['appointment_date'] ?>" name="appointment_date" data-date-picker>
            </li>
            <li>
              <label>Time</label>
              <div style="text-align:left;">
                <input type="text" value="<?php echo $dtl['appointment_time_from'] ?>" name="appointment_time_from" data-time-picker style="width:40%">
                <input type="text" value="<?php echo $dtl['appointment_time_to'] ?>" name="appointment_time_to" data-time-picker style="width:40%"></div>
            </li>                            
          </ul>
        </div>
        <div>
