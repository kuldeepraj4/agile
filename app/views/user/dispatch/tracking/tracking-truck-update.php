...
if (isset($_GET['truck_code']) && $_GET['truck_code'] != "") {
...
<section class="lg-form-outer">
    <div class="lg-form-header">Update Status of Truck : <?php echo $truck_code; ?></div>
...
<script type="text/javascript">
    function add_new() {
        ...
        $.ajax({
            url: '../user/dispatch/tracking/tracking-truck-update-action',
            type: 'POST',
            data: obj,
