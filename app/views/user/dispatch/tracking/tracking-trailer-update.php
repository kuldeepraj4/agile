...
if (isset($_GET['trailer_code']) && $_GET['trailer_code'] != "") {
...
<section class="lg-form-outer">
    <div class="lg-form-header">Update Status of Trailer : <?php echo $trailer_code; ?></div>
...
<script type="text/javascript">
    function add_new() {
        ...
        $.ajax({
            url: '../user/dispatch/tracking/tracking-trailer-update-action',
            type: 'POST',
            data: obj,
