...
<section class = 'list-200 content-box notes-b' style = 'margin: auto;max-width: 1200px'>
  ...
  <div id="addNewNoteSec" style="margin: 10px auto;display: none;">
    ...
    <form method = 'POST' id = 'addNewNoteForm' class ='aaf' onsubmit = 'return add_d_note()'>
      ...
      <input type = 'hidden' name = 'lh_assignment_eid' value = "<?php echo $_GET['eid'] ?>">
      <div class="aaf-a">
  ...
  <script type = 'text/javascript'>
    function show_d_notes() {
      $.ajax( {
        url:'../user/dispatch/notes/lh-assignment/notes-list-ajax',
        type:'POST',
        data: {
          lh_assignment_eid:'<?php echo $_GET['eid']; ?>'
        },
  ...
  <script type = 'text/javascript'>
    function add_d_note() {
      ...
      if ( isValidForm ) {
        ...
        obj['reference_type_id']='LH ASSIGNMENT';
