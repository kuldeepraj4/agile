              ...
              <tbody id="stops_table">
                ...
                <script type="text/javascript">
                  show_stop_states({
                    ...
                    default_select_location_id: '<?php echo $shipper['location_id']; ?>'
                  }, 'shipper_row');
                </script>
                ...
                ?>
                  ...
                  <script type="text/javascript">
                    show_stop_states({
                      ...
                      default_select_location_id: '<?php echo $stop['location_id']; ?>'
                    }, '<?php echo $row_id; ?>');
                  </script>
                ...
                <script type="text/javascript">
                  show_stop_states({
                    ...
                    default_select_location_id: '<?php echo $consignee['location_id']; ?>'
                  }, 'consignee_row');
                </script>
              </tbody>
