...
<section class="lg-form-outer">
  ...
  <form class="lg-form" method="POST" id="MyForm" onsubmit="return update()">
    ...
    <section class="section-1" style="width:1300px;">
      ...
      <div>
          ...
          <div class="field-section table-rows">
            ...
            <table style="width: 100%">
              ...
              <tbody id="stops_table">
                ...
                <?php if($load_type_id=='LOT03' && $details['has_shipper_range']=='YES'){
                  ?>
                  <tr data-drop-at-shipper><td style="text-align: left;">Drop at Shipper</td>
                    ...
                    <td><input class="w-100" type="text" name="drop_at_shipper_date" value="<?php echo $details['drop_at_shipper_date'] ?>" data-date-picker="" required></td>

                    <td>
                      <input class="w-100" type="text" data-time-picker style="width:60px" name="drop_at_shipper_time_from" value="<?php echo $details['drop_at_shipper_time_from'] ?>" required> &nbsp <input class="w-100" type="text" data-time-picker style="width:60px" name="drop_at_shipper_time_to" value="<?php echo $details['drop_at_shipper_time_to'] ?>" required>
                    </td>
                ...
                <td><select class="w-150" name="stop_location_id" data-default-select="<?php echo $shipper['location_id'] ?>" required></select> <i data-location-refresh class="fas fa-sync-alt" title="Refresh Cities List"></i>  <i data-add-city class="fa fa-plus" title="Add City"></i></td>

                <td><input class="w-100" type="text" name="stop_date" value="<?php echo $shipper['date'];  ?>" data-date-picker="" required></td>

                <td>
                  <input class="w-100" type="text" data-time-picker style="width:60px" name="stop_time_from" value="<?php echo $shipper['time_from'];  ?>" 
                  <?php 
                  if($shipper['datetime_tbd']=='YES'){echo "disabled";} 
                  if($shipper['datetime_tbd']=='NO'){echo "required";} 
                  ?>
                  > 
                ...
                <td></td>
                <td><input data-hide-range type="checkbox" <?php echo ($load_type_id=='LOT03' && $details['has_shipper_range']=='YES')?'checked':''; ?>  style="<?php echo ($load_type_id=='LOT03')?'':'display:none'; ?>" name="has_shipper_range"></td>
              </tr>
              <script type="text/javascript">
                show_stop_states({default_select:'<?php echo $shipper['state_id']; ?>',default_select_location_id:'<?php echo $shipper['location_id']; ?>'},'shipper_row');
              ...
              <td>
                ...
                <select class="w-150" name="stop_location_id" data-default-select="<?php echo $stop['location_id'];  ?>"  required></select><i data-location-refresh class="fas fa-sync-alt" title="Refresh Cities List"></i>  <i data-add-city class="fa fa-plus" title="Add City"></i>
              ...
              <td>
                ...
                if($stop['datetime_tbd']=='YES'){echo "disabled";} 
                if($stop['datetime_tbd']=='NO'){echo "required";} 
              ?>> 
              &nbsp
        ...
        <script type="text/javascript">
          show_stop_states({default_select:'<?php echo $stop['state_id']; ?>',default_select_location_id:'<?php echo $stop['location_id']; ?>'},'<?php echo $row_id; ?>');
        </script>
      ...
      <td><select class="w-150" name="stop_location_id" data-default-select="<?php echo $consignee['location_id'] ?>" required></select> <i data-location-refresh class="fas fa-sync-alt" title="Refresh Cities List"></i>  <i data-add-city class="fa fa-plus" title="Add City"></i></td>
      ...
      <td>
        ...
        if($consignee['datetime_tbd']=='YES'){echo "disabled";} 
        if($consignee['datetime_tbd']=='NO'){echo "required";} 
      ?>> 
      &nbsp 
...
<td><input data-hide-range type="checkbox" <?php echo ($load_type_id=='LOT03' && $details['has_consignee_range']=='YES')?'checked':''; ?>  style="<?php echo ($load_type_id=='LOT03')?'':'display:none'; ?>" name="has_consignee_range"></td>

</tr>

<?php if($load_type_id=='LOT03' && $details['has_consignee_range']=='YES'){
  ?>
  <tr data-pick-at-consignee><td style="text-align: left;">Pick from consignee</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    <td><input class="w-100" type="text" name="pick_from_consignee_date" value="<?php echo $details['pick_from_consignee_date'] ?>" data-date-picker="" required></td>
    <td>
      <input class="w-100" type="text" data-time-picker style="width:60px" name="pick_from_consignee_time_from" value="<?php echo $details['pick_from_consignee_time_from'] ?>" required> &nbsp <input class="w-100" type="text" data-time-picker style="width:60px" name="pick_from_consignee_time_to" value="<?php echo $details['pick_from_consignee_time_to'] ?>" required> 
    </td>
    <td></td>
    <td></td>
    <td></td></tr>
  ...
  <script type="text/javascript">
    show_stop_states({default_select:'<?php echo $consignee['state_id']; ?>',default_select_location_id:'<?php echo $consignee['location_id']; ?>'},'consignee_row');
