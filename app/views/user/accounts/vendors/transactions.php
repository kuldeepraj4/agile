...
<section class="list-200 content-box" style="margin: auto;max-width: 900px">
  ...
  <h1 class="list-200-heading" id="heading">Vendor - Transactions</h1>
        ...
        if((typeof data)=='string'){
          ...
          if(data.status){
           ...
           $.each(data.response.list, function(index, item) {
             ...
             <td><button title="View" class="btn_grey_c"><a href="../user/accounts/vendors-payments/transactions-details?eid=`+item.eid+`"><i class="fa fa-eye"></i></a></button></td> 
