...
<!-- <div style="text-align:center;"><button type="button" class="btn_green" onclick="window.location.href='../user/maintenance/repair-orders/details?eid=<?php //echo $details['repair_order_eid'] ?>'">Go to RO Detail</button>  <button type="button" class="btn_green" onclick="back_alret()">BACK</button></div> -->
