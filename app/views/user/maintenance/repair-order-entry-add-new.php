    ...
    <div>
      <fieldset>
        <div class="field-section single-column">
          <div class="field-p">
            <label>Driver</label>
            <select name="order_driver_id" type="text" ></select>
          </div>
        </div>                  
      </fieldset>
      <fieldset>
      ...
      <fieldset>
        <div class="field-section single-column">
          <div class="field-p">
            ...
            <select data-filter="unit_type_id" onchange="show_unit_filter({unit_type_id:this.value})"></select>
          </div>
          <div class="field-p">
            <label>Unit No</label>
            <select data-filter="unit_id">
            </select>
          </div>
          <div class="field-p">
            <label>VIN No</label>
