...
<section class="form-a" style="max-width: 600px">
    <div class="form-a-header">ADD NEW - Corrective Action Trailer's</div>
    <form method="POST" id="MyForm" onsubmit="return add_new()">
        <div>
            <label>Corrective Action Name</label>
        ...
        if(isValidForm){
            ...
            $.ajax({
                ...
                success:function(data){
                 ...
                 alert(data.message);
                 if(data.status){
                    location.href="../user/maintenance/masters/corrective-action-trailers"
